...
Execute_Unload "Bug_simulation_observedflow(Wapaformula).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Bug_simulation_observedflow(Wapaformula).gdx"
