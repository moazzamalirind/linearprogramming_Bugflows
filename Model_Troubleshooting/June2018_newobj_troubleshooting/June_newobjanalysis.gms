...
*EQ8__Monthtlyrel..           sum(d,sum(p,ReleaseVol(d,p)))=e= 711477.0432;
...
*Set a level for the Bugindex objective
     ...
     SOLVE ObjAsConstraint USING nlp MAXIMIZE CombineObjective;
...
Execute_Unload "newmetric_analysis.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls newmetric_analysis.gdx"
