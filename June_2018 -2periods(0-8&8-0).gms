...
Set
          ...
          modpar                        Saving model parameter for each of the solutions for each of the scenario/ ModStat "Model Statistics", SolStat "solve Statistics", time "time taken"/
          Ext_points                    Defining Extreme Points/Min, Max/
*          time                          time a model takes for solution/time/
;
...
option  iterlim = 2000;
   ...
   ExtModeL_Stat(tot_vol,f2,"time")= ExtremePt.resusd;
...
Execute_Unload "Junel8_2periods_0to8.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Junel8_2periods_0to8.gdx"
