...
Vol_monthlyrelease(tot_vol)           Different Total volumes of water to be released in the month i.e. April 2018 in presented case (acre-ft)/V1 749286.3,V2 600000,V3 700000,V4 800000,V5 900000/
...
* Dump all input data and results to a GAMS gdx file
Execute_Unload "GamsResult_Apri1l8_ValidatReal.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls GamsResult_Apri1l8_ValidatReal.gdx"
