...
Set
          ...
          d             days in April
          p             time periods during a day /p1*p4/
...
EnergyRate(p)                Energy revenue ($ per MWH)/p1 27.53, p2 39.09,p3 60.26, p4 53.05/
Duration(p)                  Duration of period (hours)

;

Duration("p1")= 5;
*  High period weightage in a day(5 Hours or 5 by 24 i.e:0.208 of day)
Duration("p2")= 5;
* low period weightage in a day(5 Hours or 5 by 24 i.e:0.208 of day)
Duration("p3")= 4;
*  High period weightage in a day( 4 Hours or 4 by 24 i.e:0.167 of day)
Duration("p4")= 10;
* low period weightage in a day(10 Hours or 10 by 24 i.e:0.417 of day)
...
Num_of_timesteps              Total Number of timesteps used /120/
...
EQ12_EnergyGen(d,p)..                         Energy_Gen(d,p)=e= release(d,p)*0.03715*Duration(p);
...
Execute_Unload "Validation_April2018-4periods.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Validation_April2018-4periods.gdx"
