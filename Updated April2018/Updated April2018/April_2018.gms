...
EnergyRate(p)                         Energy revenue ($ per MWH) /pHigh 57, pLow 32/
...
EQ12a_EnergyGen_Max(d,p)$(ord(p)eq 1)..                    Energy_Gen(d,p)=l= 1320*Duration("pHigh");
EQ12b_EnergyGen_Max(d,p)$(ord(p)eq 2)..                    Energy_Gen(d,p)=l= 1320*Duration("pLow");
...
* Dump all input data and results to a GAMS gdx file
Execute_Unload "GamsResult_Apri1l8.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls GamsResult_Apri1l8.gdx"
