...
setwd("E:\\Project_Bugflow\\Montly_Models\\April_2018\\3days bugflow")
...
gdxfile <- "Apri1l8_3bugflowdays.gdx"
...
Ext_RelMelt$variable[Ext_RelMelt$variable=="ExtRel_Bugflow"] <- "ExtRel_Bugflow_3days"
...
Scen_RelMelt$variable[Scen_RelMelt$variable=="Rel_Bugflow"] <- "Rel_Bugflow_3days"
...
Ext_EnergyMelt$variable[Ext_EnergyMelt$variable=="ExtEnergy_Bugflow"] <- "ExtEnergy_Bugflow_3days"
...
Scen_EnergyMelt$variable[Scen_EnergyMelt$variable=="Energy_Bugflow"] <- "Energy_Bugflow_3days"
