...
initstorage                  Initial reservoir storage.. Storage observed on 31 July 2020 (acre-ft)
...
Num_of_timesteps               Total Number of timesteps used /744/
...
Execute_Unload "Aug2020_Valid(Hr).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Aug2020_Valid(Hr).gdx"
