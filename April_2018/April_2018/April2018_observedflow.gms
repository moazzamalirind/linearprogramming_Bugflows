...
*          Scen          objective function scenario values /sc1 * sc12/
...
*Use_Sim(d,p) = 0;
*Rel_vals.L(d,p)= 0;
*Set weekend days & memorial day to 1
...
Execute_Unload "Validation_April2018.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Validation_April2018.gdx"
