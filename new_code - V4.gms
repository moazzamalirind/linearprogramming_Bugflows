...
hp1(d)                        Daily Hydropower Revenue generated from High flow ($)
hp2(d)                        Daily Hydropower Revenue generated from low flow ($
...
EQ12_highhydro(d)            Daily Hydropower Revenue generated from High flow ($)
EQ13_lowhydro(d)             Daily Hydropower Revenue generated from low flow ($)
Hydro_calculation(d)         Total Daily Hydropower Revenue generated ($)
...
EQ12_highhydro(d)..          hp1(d)=e=release(d,p)$(ord(p) eq 1)*62.43*432.54*0.66*(0.746/550)*0.001*60*13;
...
EQ13_lowhydro(d)..           hp2(d)=e=release(d,p)$(ord(p) eq 2)*62.43*432.54*0.66*(0.746/550)*0.001*25*11;
...
Hydro_calculation(d)..       Daily_hp(d)=e= hp1(d)+ hp2(d);
