...
*  Only consider the current objective
   ...
   DISPLAY release.L,storage.L,ObjectiveVal.L,ReleaseVol.L,Energy_Gen.L, CombineObjective.L;
   FStore2(f2,f,tot_vol)= ObjectiveVal.L(f);
...
*Set a level for the Hydropower objective
     ...
     DISPLAY release.L,storage.L,ObjectiveVal.L,ReleaseVol.L,Energy_Gen.L, CombineObjective.L;
     Scen_store(f2,Scen,tot_vol)= ObjectiveVal.L(f2);
...
*Set a level for the Hydropower objective
     ...
     DISPLAY release.L,storage.L,ObjectiveVal.L,ReleaseVol.L,Energy_Gen.L, CombineObjective.L;
     Scen_store2(f2,Scen,tot_vol)= ObjectiveVal.L(f2);
...
Execute_Unload "Bug_simulation_Allone.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Bug_simulation_Allone.gdx"
